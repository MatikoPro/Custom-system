        ...
        <div class="card-body">
            ...
            <form action="code.php" method="POST" enctype="multipart/form-data">
                ...
                ?>
                        ...
                        <div class="col-md-6 mb-3">
                        <label for="">Gharama za Matumizi *</label>
                        <select name="expense" required class="form-control">
                            <option value="">--Chagua Matumizi--</option>
                            <option value="mikopo">Mikopo</option>
                            <option value="wafanyakazi">Wafanyakazi</option>
                            <option value="mengineyo">Mengineyo</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="">Asilimia ya Gharama *</label>
                        <input type="text" name="expense_percentage" required class="form-control" />
                    </div>
